...
class BarChart extends Component {
  ...
  componentDidMount() {
    ...
    this.getSongEgo(this.props.title, oWidth, this.props.hops);
  }
    ...
    function drawHopSlider(title, oWidth, hops) {
      ...
      function changeNumberHops(e) {
        ...
        if (selected === 1 && hops !== 1) {
          this.getSongEgo(title, oWidth, 1);
        } else if (selected === 2 && hops !== 2) {
          this.getSongEgo(title, oWidth, 2);
        } else if (selected === 3 && hops !== 3) {
          this.getSongEgo(title, oWidth, 3);
        }
      }
    }

    function drawSongEgo(nodesArrUnfiltered, linksArrUnfiltered, oWidth) {
