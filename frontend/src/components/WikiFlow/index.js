...
class WikiFlow extends Component {
  ...
  drawTimePanel() {
    ...
    g.append('rect')
      .attr('x', 733)
      .attr('y', 170)
      .attr('width', nodeWidth * 3.8)
      .attr('height', nodeWidth * 3.95)
      .attr('stroke', '#000')
      .attr('stroke-width', 2)
      .style('fill', '#ededed')
      .attr('rx', 20)
    ...
    var simulation = d3
      ...
      .force(
        ...
        d3
          ...
          .distance(50)
          .strength(0.1)
          .links(data.links.concat(data.edges)) // and this the list of links
      )
    ...
    function ticked() {
      ...
      edge
        .attr('x1', function(d) {
          if (d.target.kind == 'decomposition') {
            return d.source.x + nodeWidth;
          } else if (d.source.kind == 'decomposition') {
            return d.source.x + nodeWidth;
          } else if (d.source.kind == 'concat') {
        ...
        .attr('y1', function(d) {
          if (d.target.kind == 'decomposition') {
            return d.source.y + nodeWidth / 2;
          } else if (d.source.kind == 'decomposition') {
            return d.source.y + layerHeight / 2;
          } else if (d.source.kind == 'concat') {
        ...
        .attr('x2', function(d) {
          ...
          if (d.target.kind == 'forecast') {
            return d.target.x + nodeWidth / 2;
          }

          if (d.target.kind == 'concat') {
        ...
        .attr('y2', function(d) {
          if (d.target.kind == 'decomposition') {
            return d.target.y + layerHeight / 2;
          }
    ...
    //Copied from http://bl.ocks.org/alexhornbake/6005176
    ...
    g.append('path')
      ...
      .attr('d', makeCurlyBrace(680, 520, 680, 180, 50, 0.6));
